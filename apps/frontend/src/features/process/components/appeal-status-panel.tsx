    ...
    <section className="operations-card">
      ...
      {actionableItems.length > 0 ? (
        <FeedbackAlert
          ...
          tone="warning"
          description="A interface identificou cabimento material em pelo menos um eixo recursal, mas ainda nao recebeu a data e hora juridicamente validas para abrir contagem regressiva e protocolo."
        />
      ) : null}
          ...
          >
            <div className="cesad-stage-read__stack">
              ...
              <FeedbackAlert
                ...
                description="O protocolo permanece indisponivel fora de contexto ou sem dados suficientes para contagem segura."
