...
4. aplicar as migrations locais vigentes:
   - `npm run prisma:migrate:dev --workspace @aep-pa/backend`
5. executar seed de desenvolvimento:
   - `npm run prisma:seed --workspace @aep-pa/backend`
6. subir o backend:
   - `npm run backend:start:dev`

Se você já tiver um banco SQLite criado antes dos ajustes estruturais mais recentes do Prisma, recrie o banco local de desenvolvimento ou reaplique as migrations em um ambiente limpo antes de validar.
