...
Nota: a `BE-ARCH-01E2` implementou a primeira parte estrutural da ADR-002 com `UserSession` e a migration `20260430120000_add_user_session`; refresh funcional, cookies, CORS, frontend, contracts, revogação real, rotação real, logout server-side e auditoria formal permanecem pendentes.
